...
namespace ProjetDotnetFramework.Api.Src
{
    public class BlobManager
    {
        ...
        public BlobManager(string ContainerName)
        {
            ...
            try
            {
                ...
                string ConnectionString = "DefaultEndpointsProtocol=https;AccountName=XXX;AccountKey=XXX;EndpointSuffix=XXX";
        ...
        public string UploadFile(HttpPostedFileBase FileToUpload)
        {
            ...
            try
            {
                string FileName = Guid.NewGuid().ToString();//Path.GetFileName(FileToUpload.FileName);
        ...
        public string UploadFileStream(MemoryStream image)
        {
            string AbsoluteUri;
            try
            {
